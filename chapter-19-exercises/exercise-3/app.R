...
ui <- fluidPage(
  ...
  checkboxInput(label = "Show Trendline", inputId = "trendline", value = TRUE),
...
# This function should perform the following:
  ...
  # Assign a reactive `renderPlot()` function to the outputted 'plot' value
    ...
    selected_range <- input$price_choice
    ...
    plot <- ggplot(data = data, mapping = aes_string(x= input$feature_select, y="price", color = "cut")) +
      geom_point()
